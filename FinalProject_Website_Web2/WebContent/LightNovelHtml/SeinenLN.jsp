<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%@page import="VO.*" %>
  <%@page import="DAO.*" %>
 <% ArrayList<ProductLNSeinen>products = (ArrayList)request.getAttribute("products");%>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
 ...
 <div class="modal fade" id="myModal">
    ...
    <div class = "row">                      
     ...
     <%for(int i = 0 ; i < products.size(); i++) {%>
            	<%ProductLNSeinen articleCourant = products.get(i); %>
            ...
            <div class="col-md-2 d-flex align-items-stretch">
                ...
                <div class="col-item">
                    <div class="card shadow-lg"> 
                        <div class = "inner">
                        <form method="POST" action="CartLNSeinenServlet">
                        ...
                        <div class="card-footer">
                            ...
                            <%} else { %>	 
                             <button type="submit" name="button" value= "button<% out.print(articleCourant.getLNSeinenID()); %>" class="btn btn-outline-primary">Ajouter au panier
                             </button>
                            <%} %>
                            </form>	
				        </div>
