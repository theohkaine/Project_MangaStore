<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%@page import="VO.*" %>
  <%@page import="DAO.*" %>
 <% ArrayList<ProductLNShounen>products = (ArrayList)request.getAttribute("products");%>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
 ...
 <div class="modal fade" id="myModal">
    ...
    <div class = "row">                      
     ...
     <%for(int i = 0 ; i < products.size(); i++) {%>
            	<%ProductLNShounen articleCourant = products.get(i); %>
            ...
            <div class="col-md-2 d-flex align-items-stretch">
                ...
                <div class="col-item">
                    <div class="card shadow-lg"> 
                        <div class = "inner">
                        <form method="POST" action="CartLNShounenServlet">
                        ...
                        <div class="card-footer">
			                ...
			                {
			                %>
				                <a class="btn btn-outline-primary" href="ProductMangaSeinenServlet" data-toggle="modal" data-target="#myModal">Add To Cart
                            </a>
   
                            <%} else { %>	 
                             <button type="submit" name="button" value= "button<% out.print(articleCourant.getLNShounenID()); %>" class="btn btn-outline-primary">Add To Cart
                             </button>
                            <%} %>
                            </form>	
				        </div>
