<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%@page import="VO.*" %>
  <%@page import="DAO.*" %>
 <% ArrayList<ProductMangaSeinen>products = (ArrayList)request.getAttribute("products");%>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
    ...
    <div class="container-fluid ">
        ...
        <ul class ="navbar-nav ml-auto">
            <nav class="custom-color ">
               ...
               {
                %>             
                 Bonjour </br><a class="btn btn-primary btn-md" href = "logoutServlet" type="submit">D&eacuteconnecter</a>                      
 ...
 <div class="modal fade" id="myModal">
    ...
    <div class = "row">                      
     ...
     <%for(int i = 0 ; i < products.size(); i++) {%>
            	<%ProductMangaSeinen articleCourant = products.get(i); %>
            ...
            <div class="col-md-2 d-flex align-items-stretch">
                ...
                <div class="col-item">
                    <div class="card shadow-lg"> 
                        <div class = "inner">
                        <form method="POST" action="CartMangaSeinenServlet">
                            <img class="card-img-top" src="<% out.print(articleCourant.getMSeinenPhoto()); %>" class="img-fluid" alt="Berserk">
                            </div>
                        <div class="card-body">
                            <h5><% out.print(articleCourant.getMSeinenName()); %></h5>
                                <p class="card-text"></p>
                        </div>
                        <div class="card-footer">
                             <h5><% out.print(articleCourant.getMSeinenPrice()); %> $ CAD</h5>
			                ...
			                {
			                %>
				                <a class="btn btn-outline-primary" href="ProductMangaSeinenServlet" data-toggle="modal" data-target="#myModal">Ajouter au panier
                            </a>
   
                            <%} else { %>	 
                             <button type="submit" name="button" value= "button<% out.print(articleCourant.getMSeinenProductID()); %>" class="btn btn-outline-primary">Ajouter au panier
                             </button>
                            <%} %>
                            </form>	
				        </div>
